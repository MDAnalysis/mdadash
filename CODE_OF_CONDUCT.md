...
The mdadash _Code of Conduct_ sets the rules for the behavior of
every member in the mdadash community so that everyone can
...
mdadash is part of an engaged and respectful community made up of people from all
...
avoid, you will help us make mdadash a welcoming and productive community.
...
7. **When we disagree, try to understand why**. Disagreements, both social and
   technical, happen all the time and mdadash is no exception. It is important
   that we resolve disagreements and differing views constructively. Remember
   that we’re different. The strength of mdadash comes from its varied community
...
reported by contacting the project team at 'pardhav.maradani@gmail.com'. The project team will
...
the
[_Speak Up!_](http://web.archive.org/web/20141109123859/http://speakup.io/coc.html),
[_Django_](https://www.djangoproject.com/conduct),
[_Contributor Covenant_](http://contributor-covenant.org/),
[_Jupyter_](https://github.com/jupyter/governance/blob/master/conduct/code_of_conduct.md),
[_MolSSI_](https://github.com/MolSSI/cookiecutter-cms/blob/master/%7B%7Bcookiecutter.repo_name%7D%7D/CODE_OF_CONDUCT.md),
and [_MDAnalysis_](https://github.com/MDAnalysis/mdanalysis/blob/develop/CODE_OF_CONDUCT.md) projects,
modified by mdadash.
We are grateful to those projects for contributing these
materials under open licensing terms for us to easily reuse.

All content on this page is licensed under a [_Creative Commons
Attribution_](http://creativecommons.org/licenses/by/3.0/) license.
